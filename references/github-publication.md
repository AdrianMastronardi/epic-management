...
Read this file only when the user has approved the EPIC coverage checkpoint and asks to publish or resume publication. Read [okf-bundle.md](okf-bundle.md) first; it defines the artifacts this protocol writes.
...
- the story checklist with issue numbers after creation.
...
12. Read back issue bodies, native relationships, and PR metadata. Verify exact relationships and SHA.
...
Read the updated concepts, index, and issues back. Do not declare the EPIC closed if any story is missing, any link is indirect or unresolved, any completion section is absent, or either validator fails.
